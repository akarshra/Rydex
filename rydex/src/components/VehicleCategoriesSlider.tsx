...
export default function VehicleCategoriesSlider() {
  ...
  return (
    <section ref={sectionRef} className="w-full bg-transparent py-20 px-4 overflow-hidden">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="relative">
          ...
          <div
            ref={sliderRef}
            onScroll={onScroll}
            className="scrollbar-hide flex gap-5 pt-20 overflow-x-auto scroll-smooth pb-4 px-1"
          >
                ...
                >
                  ...
                  >
                    ...
                    <motion.div
                      ...
                      className="category-pattern absolute inset-0 pointer-events-none"
                    />
                    ...
                    <div className={`absolute bottom-5 right-5 text-[10px] font-black tabular-nums ${isHovered ? "text-white/10" : "text-black/5"}`}>
                      0{i + 1}
                    </div>
                  </motion.div>
                </motion.div>
